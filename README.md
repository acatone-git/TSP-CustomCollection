...
- Rename the extracted folder (EasyCollection) & the executable "Rename_&_Run.bat" to whatever you wish to name your collection (Cozy Games, Best Fighting Games etc.)
